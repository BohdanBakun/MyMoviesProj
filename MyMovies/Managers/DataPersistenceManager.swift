...
//  MyMovies
//
//  Created by Богдан Бакун on 24.06.2023.
//
...
class DataPersistenceManager {
    ...
    func fetchingTitlesFromDataBase(comletion: @escaping (Result<[TitleItem], Error>) -> Void) {
        ...
        do {
            ...
            comletion(.failure(DatabasError.failedToFetchData))
        }
    }
