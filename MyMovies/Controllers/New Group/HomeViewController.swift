...
//  MyMovies
//
//  Created by Богдан Бакун on 13.06.2023.
//
        ...
        APICaller.shared.getTrendingMovies { [weak self] result in
            ...
            case .success(let titles):
                ...
                self?.headerView?.configure(
                    with: TitleViewModel(titleName: selectedTitle?.original_title ?? selectedTitle?.original_name ?? "",
...
extension HomeViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView,
        ...
        guard
            let cell = tableView.dequeueReusableCell(withIdentifier: CollectionViewTableViewCell.identifier,
    ...
    // setup navigation bar as glued to the top
